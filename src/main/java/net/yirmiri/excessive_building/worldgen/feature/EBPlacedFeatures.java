...
public class EBPlacedFeatures {
    ...
    public static void bootstrap(BootstrapContext<PlacedFeature> ctx) {
        ...
        PlacementUtils.register(ctx, QUARTZ_ORE_PLACED, configuredFeatures.getOrThrow(EBConfiguredFeatures.QUARTZ_ORE),
        ...
        PlacementUtils.register(ctx, SOUL_MAGMA_PLACED, configuredFeatures.getOrThrow(EBConfiguredFeatures.SOUL_MAGMA),
        ...
        PlacementUtils.register(ctx, FIERY_GEODE_PLACED, configuredFeatures.getOrThrow(EBConfiguredFeatures.FIERY_GEODE),
        ...
        PlacementUtils.register(ctx, KYANITE_GEODE_PLACED, configuredFeatures.getOrThrow(EBConfiguredFeatures.KYANITE_GEODE),
                List.of(RarityFilter.onAverageOnceEvery(48), InSquarePlacement.spread(),
                        HeightRangePlacement.uniform(VerticalAnchor.aboveBottom(80), VerticalAnchor.absolute(128)), BiomeFilter.biome()));

        PlacementUtils.register(ctx, ROSE_PLACED, configuredFeatures.getOrThrow(EBConfiguredFeatures.ROSE),
                RarityFilter.onAverageOnceEvery(16), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome());

        PlacementUtils.register(ctx, CYAN_ROSE_PLACED, configuredFeatures.getOrThrow(EBConfiguredFeatures.CYAN_ROSE),
                RarityFilter.onAverageOnceEvery(12), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome());

        PlacementUtils.register(ctx, WHITE_ROSE_PLACED, configuredFeatures.getOrThrow(EBConfiguredFeatures.WHITE_ROSE),
                RarityFilter.onAverageOnceEvery(8), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome());

        PlacementUtils.register(ctx, WILLOW_TREE_PLACED, configuredFeatures.getOrThrow(EBConfiguredFeatures.WILLOW_TREE), //placed, % chance for extra, extra
                VegetationPlacements.treePlacement(PlacementUtils.countExtra(3, 0.25f, 1), EBBlocks.WILLOW_SAPLING.get()));

        PlacementUtils.register(ctx, RED_MAPLE_TREE_PLACED, configuredFeatures.getOrThrow(EBConfiguredFeatures.RED_MAPLE_TREE), //placed, % chance for extra, extra
                VegetationPlacements.treePlacement(PlacementUtils.countExtra(2, 0.25f, 1), EBBlocks.RED_MAPLE_SAPLING.get()));

        PlacementUtils.register(ctx, ORANGE_MAPLE_TREE_PLACED, configuredFeatures.getOrThrow(EBConfiguredFeatures.ORANGE_MAPLE_TREE), //placed, % chance for extra, extra
                VegetationPlacements.treePlacement(PlacementUtils.countExtra(2, 0.25f, 1), EBBlocks.ORANGE_MAPLE_SAPLING.get()));

        PlacementUtils.register(ctx, YELLOW_MAPLE_TREE_PLACED, configuredFeatures.getOrThrow(EBConfiguredFeatures.YELLOW_MAPLE_TREE), //placed, % chance for extra, extra
                VegetationPlacements.treePlacement(PlacementUtils.countExtra(2, 0.25f, 1), EBBlocks.YELLOW_MAPLE_SAPLING.get()));

        PlacementUtils.register(ctx, MARIGOLD_PLACED, configuredFeatures.getOrThrow(EBConfiguredFeatures.MARIGOLD),
                RarityFilter.onAverageOnceEvery(16), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome());

        PlacementUtils.register(ctx, RED_MAPLE_PILE_PLACED, configuredFeatures.getOrThrow(EBConfiguredFeatures.RED_MAPLE_PILE),
                RarityFilter.onAverageOnceEvery(16), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome());

        PlacementUtils.register(ctx, ORANGE_MAPLE_PILE_PLACED, configuredFeatures.getOrThrow(EBConfiguredFeatures.ORANGE_MAPLE_PILE),
                RarityFilter.onAverageOnceEvery(16), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome());

        PlacementUtils.register(ctx, YELLOW_MAPLE_PILE_PLACED, configuredFeatures.getOrThrow(EBConfiguredFeatures.YELLOW_MAPLE_PILE),
                RarityFilter.onAverageOnceEvery(16), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome());

        PlacementUtils.register(ctx, COMMON_PUMPKIN_PATCH_PLACED, configuredFeatures.getOrThrow(EBConfiguredFeatures.COMMON_PUMPKIN_PATCH),
                RarityFilter.onAverageOnceEvery(800), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome());

        PlacementUtils.register(ctx, BRIMSTONE_PLACED, configuredFeatures.getOrThrow(EBConfiguredFeatures.BRIMSTONE),
        ...
        PlacementUtils.register(ctx, GOLDEN_BIRCH_TREE_PLACED, configuredFeatures.getOrThrow(EBConfiguredFeatures.GOLDEN_BIRCH_TREE), //placed, % chance for extra, extra
                VegetationPlacements.treePlacement(PlacementUtils.countExtra(16, 0.2f, 1), EBBlocks.GOLDEN_BIRCH_SAPLING.get()));

        PlacementUtils.register(ctx, MIRALEN_GEODE_PLACED, configuredFeatures.getOrThrow(EBConfiguredFeatures.MIRALEN_GEODE),
        ...
        PlacementUtils.register(ctx, ALGAE_PLACED, configuredFeatures.getOrThrow(EBConfiguredFeatures.ALGAE),
                List.of(CountPlacement.of(32), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE, BiomeFilter.biome()));

        PlacementUtils.register(ctx, ALGAE_SMALL_PLACED, configuredFeatures.getOrThrow(EBConfiguredFeatures.ALGAE),
                List.of(CountPlacement.of(10), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE, BiomeFilter.biome()));

        PlacementUtils.register(ctx, MARBLE_PLACED, configuredFeatures.getOrThrow(EBConfiguredFeatures.MARBLE),
    ...
    private static ResourceKey<PlacedFeature> createKey(String name) {
        return ResourceKey.create(Registries.PLACED_FEATURE, ResourceLocation.fromNamespaceAndPath(ExcessiveBuilding.MOD_ID, name));
    }
