...
public class EBItems {
    ...
    public static final RegistryObject<Item> ALGAE = ITEMS.register("algae",
            () -> new PlaceOnWaterBlockItem(EBBlocks.ALGAE_BLOCK.get(), new Item.Properties()));

    public static final RegistryObject<Item> WILLOW_SIGN = ITEMS.register("willow_sign",
            () -> new SignItem(new Item.Properties().stacksTo(16), EBBlocks.WILLOW_SIGN.get(), EBBlocks.WILLOW_WALL_SIGN.get()));

    public static final RegistryObject<Item> WILLOW_HANGING_SIGN = ITEMS.register("willow_hanging_sign",
            () -> new HangingSignItem(EBBlocks.WILLOW_HANGING_SIGN.get(), EBBlocks.WILLOW_WALL_HANGING_SIGN.get(), new Item.Properties().stacksTo(16)));

    public static final RegistryObject<Item> MAPLE_SIGN = ITEMS.register("maple_sign",
            () -> new SignItem(new Item.Properties().stacksTo(16), EBBlocks.MAPLE_SIGN.get(), EBBlocks.MAPLE_WALL_SIGN.get()));

    public static final RegistryObject<Item> MAPLE_HANGING_SIGN = ITEMS.register("maple_hanging_sign",
            () -> new HangingSignItem(EBBlocks.MAPLE_HANGING_SIGN.get(), EBBlocks.MAPLE_WALL_HANGING_SIGN.get(), new Item.Properties().stacksTo(16)));

    public static final RegistryObject<Item> EXCESSIVE_BANNER_PATTERN = ITEMS.register("excessive_banner_pattern",
            () -> new BannerPatternItem(EBBannerTagProvider.EXCESSIVE_BANNER_PATTERN, (new Item.Properties().stacksTo(1))));
