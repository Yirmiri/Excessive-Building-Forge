...
//TODO: FINISH ORGANIZING REGISTRIES OR ELSE ILL GO FUCKING INSANE  (Keke Will go insane as well)
    ...
    public static final RegistryObject<Block> RED_MAPLE_LEAVES = registerBlock("red_maple_leaves",
            () -> new RedMapleLeavesBlock(BlockBehaviour.Properties.copy(Blocks.OAK_LEAVES).mapColor(MapColor.COLOR_RED)));
    ...
    public static final RegistryObject<Block> DRMANGOTEA = registerBlock("drmangotea", () -> new DrMangoWool(BlockBehaviour.Properties.copy(Blocks.CYAN_WOOL)));
