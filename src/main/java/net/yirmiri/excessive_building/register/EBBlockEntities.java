...
public class EBBlockEntities {
    ...
    public static final RegistryObject<BlockEntityType<EBSignBlockEntity>> EB_SIGN = BLOCK_ENTITIES.register("eb_sign", () -> BlockEntityType.Builder.of(EBSignBlockEntity::new,
            EBBlocks.ANCIENT_SIGN.get(), EBBlocks.ANCIENT_WALL_SIGN.get(), EBBlocks.WILLOW_SIGN.get(), EBBlocks.WILLOW_WALL_SIGN.get(), EBBlocks.MAPLE_SIGN.get(), EBBlocks.MAPLE_WALL_SIGN.get()
    ).build(null));
    ...
    public static final RegistryObject<BlockEntityType<EBHangingSignBlockEntity>> EB_HANGING_SIGN = BLOCK_ENTITIES.register("eb_hanging_sign", () -> BlockEntityType.Builder.of(EBHangingSignBlockEntity::new,
            EBBlocks.ANCIENT_HANGING_SIGN.get(), EBBlocks.ANCIENT_WALL_HANGING_SIGN.get(), EBBlocks.WILLOW_HANGING_SIGN.get(), EBBlocks.WILLOW_WALL_HANGING_SIGN.get(), EBBlocks.MAPLE_HANGING_SIGN.get(), EBBlocks.MAPLE_WALL_HANGING_SIGN.get()
    ).build(null));
