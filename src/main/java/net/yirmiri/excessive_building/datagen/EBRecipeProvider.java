...
public class EBRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    protected void buildRecipes(Consumer<FinishedRecipe> recipeOutput) {
        ...
        stairBuilder(EBBlocks.TUFF_STAIRS.get(), Ingredient.of(Blocks.TUFF))
                .unlockedBy(getHasName(Blocks.TUFF), has(Blocks.TUFF)).save(recipeOutput);
        ...
        stairBuilder(EBBlocks.POLISHED_TUFF_STAIRS.get(), Ingredient.of(EBBlocks.POLISHED_TUFF.get()))
                .unlockedBy(getHasName(EBBlocks.POLISHED_TUFF.get()), has(EBBlocks.POLISHED_TUFF.get())).save(recipeOutput);
        ...
        stairBuilder(EBBlocks.TUFF_BRICK_STAIRS.get(), Ingredient.of(EBBlocks.TUFF_BRICKS.get()))
                .unlockedBy(getHasName(EBBlocks.TUFF_BRICKS.get()), has(EBBlocks.TUFF_BRICKS.get())).save(recipeOutput);
        ...
        stairBuilder(EBBlocks.TUFF_TILE_STAIRS.get(), Ingredient.of(EBBlocks.TUFF_TILES.get()))
                .unlockedBy(getHasName(EBBlocks.TUFF_TILES.get()), has(EBBlocks.TUFF_TILES.get())).save(recipeOutput);
        ...
        copperbulbBuilder(EBBlocks.COPPER_BULB.get(), Ingredient.of(Blocks.COPPER_BLOCK))
                .unlockedBy(getHasName(Blocks.COPPER_BLOCK), has(Blocks.COPPER_BLOCK)).save(recipeOutput);

        copperbulbBuilder(EBBlocks.EXPOSED_COPPER_BULB.get(), Ingredient.of(Blocks.EXPOSED_COPPER))
                .unlockedBy(getHasName(Blocks.EXPOSED_COPPER), has(Blocks.EXPOSED_COPPER)).save(recipeOutput);

        copperbulbBuilder(EBBlocks.WEATHERED_COPPER_BULB.get(), Ingredient.of(Blocks.WEATHERED_COPPER))
                .unlockedBy(getHasName(Blocks.WEATHERED_COPPER), has(Blocks.WEATHERED_COPPER)).save(recipeOutput);

        copperbulbBuilder(EBBlocks.OXIDIZED_COPPER_BULB.get(), Ingredient.of(Blocks.OXIDIZED_COPPER))
                .unlockedBy(getHasName(Blocks.OXIDIZED_COPPER), has(Blocks.OXIDIZED_COPPER)).save(recipeOutput);

        copperbulbBuilder(EBBlocks.WAXED_COPPER_BULB.get(), Ingredient.of(Blocks.WAXED_COPPER_BLOCK))
                .unlockedBy(getHasName(Blocks.WAXED_COPPER_BLOCK), has(Blocks.WAXED_COPPER_BLOCK)).save(recipeOutput);

        copperbulbBuilder(EBBlocks.WAXED_EXPOSED_COPPER_BULB.get(), Ingredient.of(Blocks.WAXED_EXPOSED_COPPER))
                .unlockedBy(getHasName(Blocks.WAXED_EXPOSED_COPPER), has(Blocks.WAXED_EXPOSED_COPPER)).save(recipeOutput);

        copperbulbBuilder(EBBlocks.WAXED_WEATHERED_COPPER_BULB.get(), Ingredient.of(Blocks.WAXED_WEATHERED_COPPER))
                .unlockedBy(getHasName(Blocks.WAXED_WEATHERED_COPPER), has(Blocks.WAXED_WEATHERED_COPPER)).save(recipeOutput);

        copperbulbBuilder(EBBlocks.WAXED_OXIDIZED_COPPER_BULB.get(), Ingredient.of(Blocks.WAXED_OXIDIZED_COPPER))
                .unlockedBy(getHasName(Blocks.WAXED_OXIDIZED_COPPER), has(Blocks.WAXED_OXIDIZED_COPPER)).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.POLISHED_TUFF.get(), 4)
                .define('#', Items.TUFF)
                .pattern("##")
                .pattern("##").unlockedBy(getHasName(Items.TUFF), has(Items.TUFF)).save(recipeOutput);

        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.TUFF_BRICKS.get(), 4)
                .define('#', EBBlocks.POLISHED_TUFF.get())
                .pattern("##")
                .pattern("##").unlockedBy(getHasName(EBBlocks.POLISHED_TUFF.get()), has(EBBlocks.POLISHED_TUFF.get())).save(recipeOutput);

        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.TUFF_TILES.get(), 4)
                .define('#', EBBlocks.TUFF_BRICKS.get())
                .pattern("##")
                .pattern("##").unlockedBy(getHasName(EBBlocks.TUFF_BRICKS.get()), has(EBBlocks.TUFF_BRICKS.get())).save(recipeOutput);

        slabBuilder(RecipeCategory.DECORATIONS, EBBlocks.DIRT_SLAB.get(), Ingredient.of(Blocks.DIRT))
                .unlockedBy(getHasName(Blocks.DIRT), has(Blocks.DIRT)).save(recipeOutput);

        grateBuilder(EBBlocks.IRON_GRATE.get(), Ingredient.of(Blocks.IRON_BLOCK))
                .unlockedBy(getHasName(Blocks.IRON_BLOCK), has(Blocks.IRON_BLOCK)).save(recipeOutput);

        grateBuilder(EBBlocks.GOLD_GRATE.get(), Ingredient.of(Blocks.GOLD_BLOCK))
                .unlockedBy(getHasName(Blocks.GOLD_BLOCK), has(Blocks.GOLD_BLOCK)).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.POLISHED_BLACKSTONE_TILES.get(), 4)
                ...
                .pattern("##")
                .pattern("##").unlockedBy(getHasName(Blocks.POLISHED_BLACKSTONE_BRICKS), has(Blocks.POLISHED_BLACKSTONE_BRICKS)).save(recipeOutput);

        stairBuilder(EBBlocks.POLISHED_BLACKSTONE_TILE_STAIRS.get(), Ingredient.of(EBBlocks.POLISHED_BLACKSTONE_TILES.get()))
                .unlockedBy(getHasName(EBBlocks.POLISHED_BLACKSTONE_TILES.get()), has(EBBlocks.POLISHED_BLACKSTONE_TILES.get())).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.POLISHED_STONE.get(), 4)
                ...
                .pattern("#@")
                .pattern("@#").unlockedBy(getHasName(Blocks.SMOOTH_STONE), has(Blocks.SMOOTH_STONE)).save(recipeOutput);

        stairBuilder(EBBlocks.POLISHED_STONE_STAIRS.get(), Ingredient.of(EBBlocks.POLISHED_STONE.get()))
                .unlockedBy(getHasName(EBBlocks.POLISHED_STONE.get()), has(EBBlocks.POLISHED_STONE.get())).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.POLISHED_STONE_BRICKS.get(), 4)
                ...
                .pattern("##")
                .pattern("##").unlockedBy(getHasName(EBBlocks.POLISHED_STONE.get()), has(EBBlocks.POLISHED_STONE.get())).save(recipeOutput);

        stairBuilder(EBBlocks.POLISHED_STONE_BRICK_STAIRS.get(), Ingredient.of(EBBlocks.POLISHED_STONE_BRICKS.get()))
                .unlockedBy(getHasName(EBBlocks.POLISHED_STONE_BRICKS.get()), has(EBBlocks.POLISHED_STONE_BRICKS.get())).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.HERRINGBONE_BRICKS.get(), 2)
                ...
                .pattern("##")
                .pattern("##").unlockedBy(getHasName(Blocks.BRICK_SLAB), has(Blocks.BRICK_SLAB)).save(recipeOutput);
        ...
        stairBuilder(EBBlocks.BASKETWEAVE_BRICK_STAIRS.get(), Ingredient.of(EBBlocks.BASKETWEAVE_BRICKS.get()))
                .unlockedBy(getHasName(EBBlocks.BASKETWEAVE_BRICKS.get()), has(EBBlocks.BASKETWEAVE_BRICKS.get())).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.SMOOTH_HERRINGBONE_BRICKS.get(), 2)
                ...
                .pattern("##")
                .pattern("##").unlockedBy(getHasName(EBBlocks.SMOOTH_BRICK_SLAB.get()), has(EBBlocks.SMOOTH_BRICK_SLAB.get())).save(recipeOutput);
        ...
        stairBuilder(EBBlocks.SMOOTH_BASKETWEAVE_BRICK_STAIRS.get(), Ingredient.of(EBBlocks.SMOOTH_BASKETWEAVE_BRICKS.get()))
                .unlockedBy(getHasName(EBBlocks.SMOOTH_BASKETWEAVE_BRICKS.get()), has(EBBlocks.SMOOTH_BASKETWEAVE_BRICKS.get())).save(recipeOutput);
        ...
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(Blocks.BRICKS), RecipeCategory.BUILDING_BLOCKS, EBBlocks.CRACKED_BRICKS.get(), 0.1F, 200)
                .unlockedBy(getHasName(Blocks.BRICKS), has(Blocks.BRICKS)).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, EBBlocks.STONE_LAMP.get(), 4)
                ...
                .pattern("@#@")
                .pattern("#@#")
                .pattern("@#@").unlockedBy(getHasName(EBItems.FIERY_SHARDS.get()), has(EBItems.FIERY_SHARDS.get())).save(recipeOutput);
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, EBBlocks.SWIFT_ASPHALT.get(), 8)
                ...
                .unlockedBy(getHasName(EBBlocks.ASPHALT.get()), has(EBBlocks.ASPHALT.get())).save(recipeOutput);
        ...
        stairBuilder(EBBlocks.SWIFT_ASPHALT_STAIRS.get(), Ingredient.of(EBBlocks.SWIFT_ASPHALT.get()))
                .unlockedBy(getHasName(EBBlocks.SWIFT_ASPHALT.get()), has(EBBlocks.SWIFT_ASPHALT.get())).save(recipeOutput);
        ...
        stairBuilder(EBBlocks.ANCIENT_STAIRS.get(), Ingredient.of(EBBlocks.ANCIENT_PLANKS.get()))
                .unlockedBy(getHasName(EBBlocks.ANCIENT_PLANKS.get()), has(EBBlocks.ANCIENT_PLANKS.get())).save(recipeOutput);
        ...
        stairBuilder(EBBlocks.ANCIENT_MOSAIC_STAIRS.get(), Ingredient.of(EBBlocks.ANCIENT_MOSAIC.get()))
                .unlockedBy(getHasName(EBBlocks.ANCIENT_MOSAIC.get()), has(EBBlocks.ANCIENT_MOSAIC.get())).save(recipeOutput);
        ...
        EBmosaicBuilder(EBBlocks.ANCIENT_MOSAIC.get(), Ingredient.of(EBBlocks.ANCIENT_SLAB.get()))
                .unlockedBy(getHasName(EBBlocks.ANCIENT_SLAB.get()), has(EBBlocks.ANCIENT_SLAB.get())).save(recipeOutput);
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, EBBlocks.ANCIENT_PLANKS.get(), 4).requires(EBBlocks.ANCIENT_LOG.get())
                .unlockedBy(getHasName(EBBlocks.ANCIENT_LOG.get()), has(EBBlocks.ANCIENT_LOG.get())).save(recipeOutput);
        ...
        woodBuilder(EBBlocks.STRIPPED_ANCIENT_WOOD.get(), Ingredient.of(EBBlocks.STRIPPED_ANCIENT_LOG.get()))
                .unlockedBy(getHasName(EBBlocks.STRIPPED_ANCIENT_LOG.get()), has(EBBlocks.STRIPPED_ANCIENT_LOG.get())).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.REDSTONE, EBBlocks.ANCIENT_PRESSURE_PLATE.get())
                ...
                .pattern("##").unlockedBy(getHasName(EBBlocks.ANCIENT_PLANKS.get()), has(EBBlocks.ANCIENT_PLANKS.get())).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.RAINBOW_WOOL.get(), 9)
                ...
                .pattern("ROY")
                .pattern("LGC")
                .pattern("BPI").unlockedBy(getHasName(EBBlocks.RAINBOW_WOOL.get()), has(EBBlocks.RAINBOW_WOOL.get())).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.RAINBOW_TERRACOTTA_TILES.get(), 9)
                ...
                .pattern("ROY")
                .pattern("LGC")
                .pattern("BPI").unlockedBy(getHasName(EBBlocks.RAINBOW_TERRACOTTA_TILES.get()), has(EBBlocks.RAINBOW_TERRACOTTA_TILES.get())).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.RAINBOW_STAINED_GLASS.get(), 9)
                ...
                .pattern("ROY")
                .pattern("LGC")
                .pattern("BPI").unlockedBy(getHasName(EBBlocks.RAINBOW_STAINED_GLASS.get()), has(EBBlocks.RAINBOW_STAINED_GLASS.get())).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, EBBlocks.RAINBOW_STAINED_GLASS_PANE.get(), 16)
                ...
                .pattern("###")
                .pattern("###").unlockedBy(getHasName(EBBlocks.RAINBOW_STAINED_GLASS.get()), has(EBBlocks.RAINBOW_STAINED_GLASS.get())).save(recipeOutput);

        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, EBBlocks.RAINBOW_CARPET.get(), 6)
                .define('#', EBBlocks.RAINBOW_WOOL.get())
                .pattern("##").unlockedBy(getHasName(EBBlocks.RAINBOW_WOOL.get()), has(EBBlocks.RAINBOW_WOOL.get())).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.RAINBOW_TERRACOTTA_BRICKS.get(), 9)
                ...
                .pattern("ROY")
                .pattern("LGC")
                .pattern("BPI").unlockedBy(getHasName(EBBlocks.RAINBOW_TERRACOTTA_BRICKS.get()), has(EBBlocks.RAINBOW_TERRACOTTA_BRICKS.get())).save(recipeOutput);

        stairBuilder(EBBlocks.RAINBOW_TERRACOTTA_BRICK_STAIRS.get(), Ingredient.of(EBBlocks.RAINBOW_TERRACOTTA_BRICKS.get()))
                .unlockedBy(getHasName(EBBlocks.RAINBOW_TERRACOTTA_BRICKS.get()), has(EBBlocks.RAINBOW_TERRACOTTA_BRICKS.get())).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.COBBLESTONE_BRICKS.get(), 4)
                ...
                .pattern("##")
                .pattern("##").unlockedBy(getHasName(Blocks.COBBLESTONE), has(Blocks.COBBLESTONE)).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.COBBLED_DEEPSLATE_BRICKS.get(), 4)
                ...
                .pattern("@#")
                .pattern("#@").unlockedBy(getHasName(Blocks.COBBLED_DEEPSLATE), has(Blocks.COBBLED_DEEPSLATE)).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.BLACKSTONE_BRICKS.get(), 4)
                ...
                .pattern("@#")
                .pattern("#@").unlockedBy(getHasName(Blocks.POLISHED_BLACKSTONE), has(Blocks.POLISHED_BLACKSTONE)).save(recipeOutput);

        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.TERRACOTTA_BRICKS.get(), 4)
                .define('#', Blocks.TERRACOTTA)
                .pattern("##")
                .pattern("##").unlockedBy(getHasName(Blocks.TERRACOTTA), has(Blocks.TERRACOTTA)).save(recipeOutput);

        stairBuilder(EBBlocks.TERRACOTTA_BRICK_STAIRS.get(), Ingredient.of(EBBlocks.TERRACOTTA_BRICKS.get()))
                .unlockedBy(getHasName(EBBlocks.TERRACOTTA_BRICKS.get()), has(EBBlocks.TERRACOTTA_BRICKS.get())).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.RED_TERRACOTTA_BRICKS.get(), 4)
                ...
                .pattern("##")
                .pattern("##").unlockedBy(getHasName(Blocks.RED_TERRACOTTA), has(Blocks.RED_TERRACOTTA)).save(recipeOutput);

        stairBuilder(EBBlocks.RED_TERRACOTTA_BRICK_STAIRS.get(), Ingredient.of(EBBlocks.RED_TERRACOTTA_BRICKS.get()))
                .unlockedBy(getHasName(EBBlocks.RED_TERRACOTTA_BRICKS.get()), has(EBBlocks.RED_TERRACOTTA_BRICKS.get())).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.ORANGE_TERRACOTTA_BRICKS.get(), 4)
                ...
                .pattern("##")
                .pattern("##").unlockedBy(getHasName(Blocks.ORANGE_TERRACOTTA), has(Blocks.ORANGE_TERRACOTTA)).save(recipeOutput);

        stairBuilder(EBBlocks.ORANGE_TERRACOTTA_BRICK_STAIRS.get(), Ingredient.of(EBBlocks.ORANGE_TERRACOTTA_BRICKS.get()))
                .unlockedBy(getHasName(EBBlocks.ORANGE_TERRACOTTA_BRICKS.get()), has(EBBlocks.ORANGE_TERRACOTTA_BRICKS.get())).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.YELLOW_TERRACOTTA_BRICKS.get(), 4)
                ...
                .pattern("##")
                .pattern("##").unlockedBy(getHasName(Blocks.YELLOW_TERRACOTTA), has(Blocks.YELLOW_TERRACOTTA)).save(recipeOutput);

        stairBuilder(EBBlocks.YELLOW_TERRACOTTA_BRICK_STAIRS.get(), Ingredient.of(EBBlocks.YELLOW_TERRACOTTA_BRICKS.get()))
                .unlockedBy(getHasName(EBBlocks.YELLOW_TERRACOTTA_BRICKS.get()), has(EBBlocks.YELLOW_TERRACOTTA_BRICKS.get())).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.LIME_TERRACOTTA_BRICKS.get(), 4)
                ...
                .pattern("##")
                .pattern("##").unlockedBy(getHasName(Blocks.LIME_TERRACOTTA), has(Blocks.LIME_TERRACOTTA)).save(recipeOutput);

        stairBuilder(EBBlocks.LIME_TERRACOTTA_BRICK_STAIRS.get(), Ingredient.of(EBBlocks.LIME_TERRACOTTA_BRICKS.get()))
                .unlockedBy(getHasName(EBBlocks.LIME_TERRACOTTA_BRICKS.get()), has(EBBlocks.LIME_TERRACOTTA_BRICKS.get())).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.GREEN_TERRACOTTA_BRICKS.get(), 4)
                ...
                .pattern("##")
                .pattern("##").unlockedBy(getHasName(Blocks.GREEN_TERRACOTTA), has(Blocks.GREEN_TERRACOTTA)).save(recipeOutput);

        stairBuilder(EBBlocks.GREEN_TERRACOTTA_BRICK_STAIRS.get(), Ingredient.of(EBBlocks.GREEN_TERRACOTTA_BRICKS.get()))
                .unlockedBy(getHasName(EBBlocks.GREEN_TERRACOTTA_BRICKS.get()), has(EBBlocks.GREEN_TERRACOTTA_BRICKS.get())).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.BLUE_TERRACOTTA_BRICKS.get(), 4)
                ...
                .pattern("##")
                .pattern("##").unlockedBy(getHasName(Blocks.BLUE_TERRACOTTA), has(Blocks.BLUE_TERRACOTTA)).save(recipeOutput);

        stairBuilder(EBBlocks.BLUE_TERRACOTTA_BRICK_STAIRS.get(), Ingredient.of(EBBlocks.BLUE_TERRACOTTA_BRICKS.get()))
                .unlockedBy(getHasName(EBBlocks.BLUE_TERRACOTTA_BRICKS.get()), has(EBBlocks.BLUE_TERRACOTTA_BRICKS.get())).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.LIGHT_BLUE_TERRACOTTA_BRICKS.get(), 4)
                ...
                .pattern("##")
                .pattern("##").unlockedBy(getHasName(Blocks.LIGHT_BLUE_TERRACOTTA), has(Blocks.LIGHT_BLUE_TERRACOTTA)).save(recipeOutput);

        stairBuilder(EBBlocks.LIGHT_BLUE_TERRACOTTA_BRICK_STAIRS.get(), Ingredient.of(EBBlocks.LIGHT_BLUE_TERRACOTTA_BRICKS.get()))
                .unlockedBy(getHasName(EBBlocks.LIGHT_BLUE_TERRACOTTA_BRICKS.get()), has(EBBlocks.LIGHT_BLUE_TERRACOTTA_BRICKS.get())).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.CYAN_TERRACOTTA_BRICKS.get(), 4)
                ...
                .pattern("##")
                .pattern("##").unlockedBy(getHasName(Blocks.CYAN_TERRACOTTA), has(Blocks.CYAN_TERRACOTTA)).save(recipeOutput);

        stairBuilder(EBBlocks.CYAN_TERRACOTTA_BRICK_STAIRS.get(), Ingredient.of(EBBlocks.CYAN_TERRACOTTA_BRICKS.get()))
                .unlockedBy(getHasName(EBBlocks.CYAN_TERRACOTTA_BRICKS.get()), has(EBBlocks.CYAN_TERRACOTTA_BRICKS.get())).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.PURPLE_TERRACOTTA_BRICKS.get(), 4)
                ...
                .pattern("##")
                .pattern("##").unlockedBy(getHasName(Blocks.PURPLE_TERRACOTTA), has(Blocks.PURPLE_TERRACOTTA)).save(recipeOutput);

        stairBuilder(EBBlocks.PURPLE_TERRACOTTA_BRICK_STAIRS.get(), Ingredient.of(EBBlocks.PURPLE_TERRACOTTA_BRICKS.get()))
                .unlockedBy(getHasName(EBBlocks.PURPLE_TERRACOTTA_BRICKS.get()), has(EBBlocks.PURPLE_TERRACOTTA_BRICKS.get())).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.MAGENTA_TERRACOTTA_BRICKS.get(), 4)
                ...
                .pattern("##")
                .pattern("##").unlockedBy(getHasName(Blocks.MAGENTA_TERRACOTTA), has(Blocks.MAGENTA_TERRACOTTA)).save(recipeOutput);

        stairBuilder(EBBlocks.MAGENTA_TERRACOTTA_BRICK_STAIRS.get(), Ingredient.of(EBBlocks.MAGENTA_TERRACOTTA_BRICKS.get()))
                .unlockedBy(getHasName(EBBlocks.MAGENTA_TERRACOTTA_BRICKS.get()), has(EBBlocks.MAGENTA_TERRACOTTA_BRICKS.get())).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.PINK_TERRACOTTA_BRICKS.get(), 4)
                ...
                .pattern("##")
                .pattern("##").unlockedBy(getHasName(Blocks.PINK_TERRACOTTA), has(Blocks.PINK_TERRACOTTA)).save(recipeOutput);

        stairBuilder(EBBlocks.PINK_TERRACOTTA_BRICK_STAIRS.get(), Ingredient.of(EBBlocks.PINK_TERRACOTTA_BRICKS.get()))
                .unlockedBy(getHasName(EBBlocks.PINK_TERRACOTTA_BRICKS.get()), has(EBBlocks.PINK_TERRACOTTA_BRICKS.get())).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.BROWN_TERRACOTTA_BRICKS.get(), 4)
                ...
                .pattern("##")
                .pattern("##").unlockedBy(getHasName(Blocks.BROWN_TERRACOTTA), has(Blocks.BROWN_TERRACOTTA)).save(recipeOutput);

        stairBuilder(EBBlocks.BROWN_TERRACOTTA_BRICK_STAIRS.get(), Ingredient.of(EBBlocks.BROWN_TERRACOTTA_BRICKS.get()))
                .unlockedBy(getHasName(EBBlocks.BROWN_TERRACOTTA_BRICKS.get()), has(EBBlocks.BROWN_TERRACOTTA_BRICKS.get())).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.BLACK_TERRACOTTA_BRICKS.get(), 4)
                ...
                .pattern("##")
                .pattern("##").unlockedBy(getHasName(Blocks.BLACK_TERRACOTTA), has(Blocks.BLACK_TERRACOTTA)).save(recipeOutput);

        stairBuilder(EBBlocks.BLACK_TERRACOTTA_BRICK_STAIRS.get(), Ingredient.of(EBBlocks.BLACK_TERRACOTTA_BRICKS.get()))
                .unlockedBy(getHasName(EBBlocks.BLACK_TERRACOTTA_BRICKS.get()), has(EBBlocks.BLACK_TERRACOTTA_BRICKS.get())).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.WHITE_TERRACOTTA_BRICKS.get(), 4)
                ...
                .pattern("##")
                .pattern("##").unlockedBy(getHasName(Blocks.WHITE_TERRACOTTA), has(Blocks.WHITE_TERRACOTTA)).save(recipeOutput);

        stairBuilder(EBBlocks.WHITE_TERRACOTTA_BRICK_STAIRS.get(), Ingredient.of(EBBlocks.WHITE_TERRACOTTA_BRICKS.get()))
                .unlockedBy(getHasName(EBBlocks.WHITE_TERRACOTTA_BRICKS.get()), has(EBBlocks.WHITE_TERRACOTTA_BRICKS.get())).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.GRAY_TERRACOTTA_BRICKS.get(), 4)
                ...
                .pattern("##")
                .pattern("##").unlockedBy(getHasName(Blocks.GRAY_TERRACOTTA), has(Blocks.GRAY_TERRACOTTA)).save(recipeOutput);

        stairBuilder(EBBlocks.GRAY_TERRACOTTA_BRICK_STAIRS.get(), Ingredient.of(EBBlocks.GRAY_TERRACOTTA_BRICKS.get()))
                .unlockedBy(getHasName(EBBlocks.GRAY_TERRACOTTA_BRICKS.get()), has(EBBlocks.GRAY_TERRACOTTA_BRICKS.get())).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.LIGHT_GRAY_TERRACOTTA_BRICKS.get(), 4)
                ...
                .pattern("##")
                .pattern("##").unlockedBy(getHasName(Blocks.LIGHT_GRAY_TERRACOTTA), has(Blocks.LIGHT_GRAY_TERRACOTTA)).save(recipeOutput);

        stairBuilder(EBBlocks.LIGHT_GRAY_TERRACOTTA_BRICK_STAIRS.get(), Ingredient.of(EBBlocks.LIGHT_GRAY_TERRACOTTA_BRICKS.get()))
                .unlockedBy(getHasName(EBBlocks.LIGHT_GRAY_TERRACOTTA_BRICKS.get()), has(EBBlocks.LIGHT_GRAY_TERRACOTTA_BRICKS.get())).save(recipeOutput);
        ...
        slabBuilder(RecipeCategory.BUILDING_BLOCKS, EBBlocks.GRASS_SLAB.get(), Ingredient.of(Blocks.GRASS_BLOCK))
                .unlockedBy(getHasName(Blocks.GRASS_BLOCK), has(Blocks.GRASS_BLOCK)).save(recipeOutput);

        slabBuilder(RecipeCategory.BUILDING_BLOCKS, EBBlocks.ROOTED_DIRT_SLAB.get(), Ingredient.of(Blocks.ROOTED_DIRT))
                .unlockedBy(getHasName(Blocks.ROOTED_DIRT), has(Blocks.ROOTED_DIRT)).save(recipeOutput);

        slabBuilder(RecipeCategory.BUILDING_BLOCKS, EBBlocks.COARSE_DIRT_SLAB.get(), Ingredient.of(Blocks.COARSE_DIRT))
                .unlockedBy(getHasName(Blocks.COARSE_DIRT), has(Blocks.COARSE_DIRT)).save(recipeOutput);
        ...
        stairBuilder(EBBlocks.NETHERRACK_STAIRS.get(), Ingredient.of(Blocks.NETHERRACK))
                .unlockedBy(getHasName(Blocks.NETHERRACK), has(Blocks.NETHERRACK)).save(recipeOutput);
        ...
        stairBuilder(EBBlocks.SMOOTH_BASALT_STAIRS.get(), Ingredient.of(Blocks.SMOOTH_BASALT))
                .unlockedBy(getHasName(Blocks.SMOOTH_BASALT), has(Blocks.SMOOTH_BASALT)).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, EBBlocks.KYANITE_LAMP.get(), 2)
                ...
                .pattern("@#@")
                .pattern("#@#")
                .pattern("@#@").unlockedBy(getHasName(EBItems.KYANITE_SHARDS.get()), has(EBItems.KYANITE_SHARDS.get())).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, EBBlocks.KYANITE_GLASS_PANE.get(), 16)
                ...
                .pattern("###")
                .pattern("###").unlockedBy(getHasName(EBBlocks.KYANITE_GLASS.get()), has(EBBlocks.KYANITE_GLASS.get())).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.AMETHYST_GLASS.get(), 4)
                ...
                .pattern("@#@")
                .pattern("#@#")
                .pattern("@#@").unlockedBy(getHasName(Items.AMETHYST_SHARD), has(Items.AMETHYST_SHARD)).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.PRISMARINE_GLASS.get(), 4)
                ...
                .pattern("@#@")
                .pattern("#@#")
                .pattern("@#@").unlockedBy(getHasName(Items.PRISMARINE_CRYSTALS), has(Items.PRISMARINE_CRYSTALS)).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.AMETHYST_BRICKS.get(), 4)
                ...
                .pattern("##")
                .pattern("##").unlockedBy(getHasName(Blocks.AMETHYST_BLOCK), has(Blocks.AMETHYST_BLOCK)).save(recipeOutput);
        ...
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(EBBlocks.AMETHYST_BRICKS.get()), RecipeCategory.BUILDING_BLOCKS, EBBlocks.CRACKED_AMETHYST_BRICKS.get(), 0.1F, 200)
                .unlockedBy(getHasName(EBBlocks.AMETHYST_BRICKS.get()), has(EBBlocks.AMETHYST_BRICKS.get())).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.AMETHYST_TILES.get(), 4)
                ...
                .pattern("##")
                .pattern("##").unlockedBy(getHasName(EBBlocks.AMETHYST_BRICKS.get()), has(EBBlocks.AMETHYST_BRICKS.get())).save(recipeOutput);
        ...
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(EBBlocks.AMETHYST_TILES.get()), RecipeCategory.BUILDING_BLOCKS, EBBlocks.CRACKED_AMETHYST_TILES.get(), 0.1F, 200)
                .unlockedBy(getHasName(EBBlocks.AMETHYST_TILES.get()), has(EBBlocks.AMETHYST_TILES.get())).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.PRISMARINE_CRYSTAL_BRICKS.get(), 4)
                ...
                .pattern("##")
                .pattern("##").unlockedBy(getHasName(EBBlocks.PRISMARINE_CRYSTAL_BLOCK.get()), has(EBBlocks.PRISMARINE_CRYSTAL_BLOCK.get())).save(recipeOutput);
        ...
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(EBBlocks.PRISMARINE_CRYSTAL_BRICKS.get()), RecipeCategory.BUILDING_BLOCKS, EBBlocks.CRACKED_PRISMARINE_CRYSTAL_BRICKS.get(), 0.1F, 200)
                .unlockedBy(getHasName(EBBlocks.PRISMARINE_CRYSTAL_BRICKS.get()), has(EBBlocks.PRISMARINE_CRYSTAL_BRICKS.get())).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.PRISMARINE_CRYSTAL_TILES.get(), 4)
                ...
                .pattern("##")
                .pattern("##").unlockedBy(getHasName(EBBlocks.PRISMARINE_CRYSTAL_BRICKS.get()), has(EBBlocks.PRISMARINE_CRYSTAL_BRICKS.get())).save(recipeOutput);
        ...
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(EBBlocks.PRISMARINE_CRYSTAL_TILES.get()), RecipeCategory.BUILDING_BLOCKS, EBBlocks.CRACKED_PRISMARINE_CRYSTAL_TILES.get(), 0.1F, 200)
                .unlockedBy(getHasName(EBBlocks.PRISMARINE_CRYSTAL_TILES.get()), has(EBBlocks.PRISMARINE_CRYSTAL_TILES.get())).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.FIERY_BRICKS.get(), 4)
                ...
                .pattern("##")
                .pattern("##").unlockedBy(getHasName(EBBlocks.FIERY_BLOCK.get()), has(EBBlocks.FIERY_BLOCK.get())).save(recipeOutput);
        ...
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(EBBlocks.FIERY_BRICKS.get()), RecipeCategory.BUILDING_BLOCKS, EBBlocks.CRACKED_FIERY_BRICKS.get(), 0.1F, 200)
                .unlockedBy(getHasName(EBBlocks.FIERY_BRICKS.get()), has(EBBlocks.FIERY_BRICKS.get())).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.FIERY_TILES.get(), 4)
                ...
                .pattern("##")
                .pattern("##").unlockedBy(getHasName(EBBlocks.FIERY_BRICKS.get()), has(EBBlocks.FIERY_BRICKS.get())).save(recipeOutput);
        ...
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(EBBlocks.FIERY_TILES.get()), RecipeCategory.BUILDING_BLOCKS, EBBlocks.CRACKED_FIERY_TILES.get(), 0.1F, 200)
                .unlockedBy(getHasName(EBBlocks.FIERY_TILES.get()), has(EBBlocks.FIERY_TILES.get())).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.KYANITE_BRICKS.get(), 4)
                ...
                .pattern("##")
                .pattern("##").unlockedBy(getHasName(EBBlocks.KYANITE_BLOCK.get()), has(EBBlocks.KYANITE_BLOCK.get())).save(recipeOutput);
        ...
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(EBBlocks.KYANITE_BRICKS.get()), RecipeCategory.BUILDING_BLOCKS, EBBlocks.CRACKED_KYANITE_BRICKS.get(), 0.1F, 200)
                .unlockedBy(getHasName(EBBlocks.KYANITE_BRICKS.get()), has(EBBlocks.KYANITE_BRICKS.get())).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.KYANITE_TILES.get(), 4)
                ...
                .pattern("##")
                .pattern("##").unlockedBy(getHasName(EBBlocks.KYANITE_BRICKS.get()), has(EBBlocks.KYANITE_BRICKS.get())).save(recipeOutput);
        ...
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(EBBlocks.KYANITE_TILES.get()), RecipeCategory.BUILDING_BLOCKS, EBBlocks.CRACKED_KYANITE_TILES.get(), 0.1F, 200)
                .unlockedBy(getHasName(EBBlocks.KYANITE_TILES.get()), has(EBBlocks.KYANITE_TILES.get())).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.CHISELED_SMOOTH_STONE_BRICKS.get(), 1)
                ...
                .pattern("#")
                .pattern("#").unlockedBy(getHasName(EBBlocks.SMOOTH_STONE_BRICK_SLAB.get()), has(EBBlocks.SMOOTH_STONE_BRICK_SLAB.get())).save(recipeOutput);
        ...
        stairBuilder(EBBlocks.SMOOTH_TERRACOTTA_BRICK_STAIRS.get(), Ingredient.of(EBBlocks.SMOOTH_TERRACOTTA_BRICKS.get()))
                .unlockedBy(getHasName(EBBlocks.SMOOTH_TERRACOTTA_BRICKS.get()), has(EBBlocks.SMOOTH_TERRACOTTA_BRICKS.get())).save(recipeOutput);
        ...
        stairBuilder(EBBlocks.SMOOTH_RED_TERRACOTTA_BRICK_STAIRS.get(), Ingredient.of(EBBlocks.SMOOTH_RED_TERRACOTTA_BRICKS.get()))
                .unlockedBy(getHasName(EBBlocks.SMOOTH_RED_TERRACOTTA_BRICKS.get()), has(EBBlocks.SMOOTH_RED_TERRACOTTA_BRICKS.get())).save(recipeOutput);
        ...
        stairBuilder(EBBlocks.SMOOTH_ORANGE_TERRACOTTA_BRICK_STAIRS.get(), Ingredient.of(EBBlocks.SMOOTH_ORANGE_TERRACOTTA_BRICKS.get()))
                .unlockedBy(getHasName(EBBlocks.SMOOTH_ORANGE_TERRACOTTA_BRICKS.get()), has(EBBlocks.SMOOTH_ORANGE_TERRACOTTA_BRICKS.get())).save(recipeOutput);
        ...
        stairBuilder(EBBlocks.SMOOTH_YELLOW_TERRACOTTA_BRICK_STAIRS.get(), Ingredient.of(EBBlocks.SMOOTH_YELLOW_TERRACOTTA_BRICKS.get()))
                .unlockedBy(getHasName(EBBlocks.SMOOTH_YELLOW_TERRACOTTA_BRICKS.get()), has(EBBlocks.SMOOTH_YELLOW_TERRACOTTA_BRICKS.get())).save(recipeOutput);
        ...
        stairBuilder(EBBlocks.SMOOTH_LIME_TERRACOTTA_BRICK_STAIRS.get(), Ingredient.of(EBBlocks.SMOOTH_LIME_TERRACOTTA_BRICKS.get()))
                .unlockedBy(getHasName(EBBlocks.SMOOTH_LIME_TERRACOTTA_BRICKS.get()), has(EBBlocks.SMOOTH_LIME_TERRACOTTA_BRICKS.get())).save(recipeOutput);
        ...
        stairBuilder(EBBlocks.SMOOTH_GREEN_TERRACOTTA_BRICK_STAIRS.get(), Ingredient.of(EBBlocks.SMOOTH_GREEN_TERRACOTTA_BRICKS.get()))
                .unlockedBy(getHasName(EBBlocks.SMOOTH_GREEN_TERRACOTTA_BRICKS.get()), has(EBBlocks.SMOOTH_GREEN_TERRACOTTA_BRICKS.get())).save(recipeOutput);
        ...
        stairBuilder(EBBlocks.SMOOTH_BLUE_TERRACOTTA_BRICK_STAIRS.get(), Ingredient.of(EBBlocks.SMOOTH_BLUE_TERRACOTTA_BRICKS.get()))
                .unlockedBy(getHasName(EBBlocks.SMOOTH_BLUE_TERRACOTTA_BRICKS.get()), has(EBBlocks.SMOOTH_BLUE_TERRACOTTA_BRICKS.get())).save(recipeOutput);
        ...
        stairBuilder(EBBlocks.SMOOTH_LIGHT_BLUE_TERRACOTTA_BRICK_STAIRS.get(), Ingredient.of(EBBlocks.SMOOTH_LIGHT_BLUE_TERRACOTTA_BRICKS.get()))
                .unlockedBy(getHasName(EBBlocks.SMOOTH_LIGHT_BLUE_TERRACOTTA_BRICKS.get()), has(EBBlocks.SMOOTH_LIGHT_BLUE_TERRACOTTA_BRICKS.get())).save(recipeOutput);
        ...
        stairBuilder(EBBlocks.SMOOTH_CYAN_TERRACOTTA_BRICK_STAIRS.get(), Ingredient.of(EBBlocks.SMOOTH_CYAN_TERRACOTTA_BRICKS.get()))
                .unlockedBy(getHasName(EBBlocks.SMOOTH_CYAN_TERRACOTTA_BRICKS.get()), has(EBBlocks.SMOOTH_CYAN_TERRACOTTA_BRICKS.get())).save(recipeOutput);
        ...
        stairBuilder(EBBlocks.SMOOTH_PURPLE_TERRACOTTA_BRICK_STAIRS.get(), Ingredient.of(EBBlocks.SMOOTH_PURPLE_TERRACOTTA_BRICKS.get()))
                .unlockedBy(getHasName(EBBlocks.SMOOTH_PURPLE_TERRACOTTA_BRICKS.get()), has(EBBlocks.SMOOTH_PURPLE_TERRACOTTA_BRICKS.get())).save(recipeOutput);
        ...
        stairBuilder(EBBlocks.SMOOTH_MAGENTA_TERRACOTTA_BRICK_STAIRS.get(), Ingredient.of(EBBlocks.SMOOTH_MAGENTA_TERRACOTTA_BRICKS.get()))
                .unlockedBy(getHasName(EBBlocks.SMOOTH_MAGENTA_TERRACOTTA_BRICKS.get()), has(EBBlocks.SMOOTH_MAGENTA_TERRACOTTA_BRICKS.get())).save(recipeOutput);
        ...
        stairBuilder(EBBlocks.SMOOTH_PINK_TERRACOTTA_BRICK_STAIRS.get(), Ingredient.of(EBBlocks.SMOOTH_PINK_TERRACOTTA_BRICKS.get()))
                .unlockedBy(getHasName(EBBlocks.SMOOTH_PINK_TERRACOTTA_BRICKS.get()), has(EBBlocks.SMOOTH_PINK_TERRACOTTA_BRICKS.get())).save(recipeOutput);
        ...
        stairBuilder(EBBlocks.SMOOTH_BROWN_TERRACOTTA_BRICK_STAIRS.get(), Ingredient.of(EBBlocks.SMOOTH_BROWN_TERRACOTTA_BRICKS.get()))
                .unlockedBy(getHasName(EBBlocks.SMOOTH_BROWN_TERRACOTTA_BRICKS.get()), has(EBBlocks.SMOOTH_BROWN_TERRACOTTA_BRICKS.get())).save(recipeOutput);
        ...
        stairBuilder(EBBlocks.SMOOTH_BLACK_TERRACOTTA_BRICK_STAIRS.get(), Ingredient.of(EBBlocks.SMOOTH_BLACK_TERRACOTTA_BRICKS.get()))
                .unlockedBy(getHasName(EBBlocks.SMOOTH_BLACK_TERRACOTTA_BRICKS.get()), has(EBBlocks.SMOOTH_BLACK_TERRACOTTA_BRICKS.get())).save(recipeOutput);
        ...
        stairBuilder(EBBlocks.SMOOTH_WHITE_TERRACOTTA_BRICK_STAIRS.get(), Ingredient.of(EBBlocks.SMOOTH_WHITE_TERRACOTTA_BRICKS.get()))
                .unlockedBy(getHasName(EBBlocks.SMOOTH_WHITE_TERRACOTTA_BRICKS.get()), has(EBBlocks.SMOOTH_WHITE_TERRACOTTA_BRICKS.get())).save(recipeOutput);
        ...
        stairBuilder(EBBlocks.SMOOTH_GRAY_TERRACOTTA_BRICK_STAIRS.get(), Ingredient.of(EBBlocks.SMOOTH_GRAY_TERRACOTTA_BRICKS.get()))
                .unlockedBy(getHasName(EBBlocks.SMOOTH_GRAY_TERRACOTTA_BRICKS.get()), has(EBBlocks.SMOOTH_GRAY_TERRACOTTA_BRICKS.get())).save(recipeOutput);
        ...
        stairBuilder(EBBlocks.SMOOTH_LIGHT_GRAY_TERRACOTTA_BRICK_STAIRS.get(), Ingredient.of(EBBlocks.SMOOTH_LIGHT_GRAY_TERRACOTTA_BRICKS.get()))
                .unlockedBy(getHasName(EBBlocks.SMOOTH_LIGHT_GRAY_TERRACOTTA_BRICKS.get()), has(EBBlocks.SMOOTH_LIGHT_GRAY_TERRACOTTA_BRICKS.get())).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, EBBlocks.EMPTY_SHELF.get())
                ...
                .pattern("###")
                .pattern("   ")
                .pattern("###").unlockedBy(getHasName(Blocks.OAK_PLANKS), has(Blocks.OAK_PLANKS)).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, EBBlocks.SPRUCE_EMPTY_SHELF.get())
                ...
                .pattern("###")
                .pattern("   ")
                .pattern("###").unlockedBy(getHasName(Blocks.SPRUCE_PLANKS), has(Blocks.SPRUCE_PLANKS)).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, EBBlocks.MANGROVE_EMPTY_SHELF.get())
                ...
                .pattern("###")
                .pattern("   ")
                .pattern("###").unlockedBy(getHasName(Blocks.MANGROVE_PLANKS), has(Blocks.MANGROVE_PLANKS)).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, EBBlocks.CHERRY_EMPTY_SHELF.get())
                ...
                .pattern("###")
                .pattern("   ")
                .pattern("###").unlockedBy(getHasName(Blocks.CHERRY_PLANKS), has(Blocks.CHERRY_PLANKS)).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, EBBlocks.DARK_OAK_EMPTY_SHELF.get())
                ...
                .pattern("###")
                .pattern("   ")
                .pattern("###").unlockedBy(getHasName(Blocks.DARK_OAK_PLANKS), has(Blocks.DARK_OAK_PLANKS)).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, EBBlocks.ACACIA_EMPTY_SHELF.get())
                ...
                .pattern("###")
                .pattern("   ")
                .pattern("###").unlockedBy(getHasName(Blocks.ACACIA_PLANKS), has(Blocks.ACACIA_PLANKS)).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, EBBlocks.JUNGLE_EMPTY_SHELF.get())
                ...
                .pattern("###")
                .pattern("   ")
                .pattern("###").unlockedBy(getHasName(Blocks.JUNGLE_PLANKS), has(Blocks.JUNGLE_PLANKS)).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, EBBlocks.BIRCH_EMPTY_SHELF.get())
                ...
                .pattern("###")
                .pattern("   ")
                .pattern("###").unlockedBy(getHasName(Blocks.BIRCH_PLANKS), has(Blocks.BIRCH_PLANKS)).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, EBBlocks.CRIMSON_EMPTY_SHELF.get())
                ...
                .pattern("###")
                .pattern("   ")
                .pattern("###").unlockedBy(getHasName(Blocks.CRIMSON_PLANKS), has(Blocks.CRIMSON_PLANKS)).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, EBBlocks.WARPED_EMPTY_SHELF.get())
                ...
                .pattern("###")
                .pattern("   ")
                .pattern("###").unlockedBy(getHasName(Blocks.WARPED_PLANKS), has(Blocks.WARPED_PLANKS)).save(recipeOutput);
        ...
        EBmosaicBuilder(EBBlocks.SMOOTH_STONE_BRICK_PILLAR.get(), Ingredient.of(EBBlocks.SMOOTH_STONE_BRICK_SLAB.get()))
                .unlockedBy(getHasName(EBBlocks.SMOOTH_STONE_BRICK_SLAB.get()), has(EBBlocks.SMOOTH_STONE_BRICK_SLAB.get())).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, EBBlocks.POLISHED_BRIMSTONE_PEDESTAL.get(), 3)
                ...
                .pattern("###")
                .pattern(" @ ")
                .pattern("###").unlockedBy(getHasName(EBBlocks.POLISHED_BRIMSTONE_SLAB.get()), has(EBBlocks.POLISHED_BRIMSTONE_SLAB.get())).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, EBBlocks.QUARTZ_PEDESTAL.get(), 3)
                ...
                .pattern("###")
                .pattern(" @ ")
                .pattern("###").unlockedBy(getHasName(Blocks.QUARTZ_SLAB), has(Blocks.QUARTZ_SLAB)).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, EBBlocks.PURPUR_PEDESTAL.get(), 3)
                ...
                .pattern("###")
                .pattern(" @ ")
                .pattern("###").unlockedBy(getHasName(Blocks.PURPUR_SLAB), has(Blocks.PURPUR_SLAB)).save(recipeOutput);

        stairBuilder(EBBlocks.WILLOW_STAIRS.get(), Ingredient.of(EBBlocks.WILLOW_PLANKS.get()))
                .unlockedBy(getHasName(EBBlocks.WILLOW_PLANKS.get()), has(EBBlocks.WILLOW_PLANKS.get())).save(recipeOutput);
        ...
        stairBuilder(EBBlocks.WILLOW_MOSAIC_STAIRS.get(), Ingredient.of(EBBlocks.WILLOW_MOSAIC.get()))
                .unlockedBy(getHasName(EBBlocks.WILLOW_MOSAIC.get()), has(EBBlocks.WILLOW_MOSAIC.get())).save(recipeOutput);
        ...
        EBmosaicBuilder(EBBlocks.WILLOW_MOSAIC.get(), Ingredient.of(EBBlocks.WILLOW_SLAB.get()))
                .unlockedBy(getHasName(EBBlocks.WILLOW_SLAB.get()), has(EBBlocks.WILLOW_SLAB.get())).save(recipeOutput);
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, EBBlocks.WILLOW_PLANKS.get(), 4).requires(EBBlocks.WILLOW_LOG.get())
                .unlockedBy(getHasName(EBBlocks.WILLOW_LOG.get()), has(EBBlocks.WILLOW_LOG.get())).save(recipeOutput);
        ...
        woodBuilder(EBBlocks.STRIPPED_WILLOW_WOOD.get(), Ingredient.of(EBBlocks.STRIPPED_WILLOW_LOG.get()))
                .unlockedBy(getHasName(EBBlocks.STRIPPED_WILLOW_LOG.get()), has(EBBlocks.STRIPPED_WILLOW_LOG.get())).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.REDSTONE, EBBlocks.WILLOW_PRESSURE_PLATE.get())
                ...
                .pattern("##").unlockedBy(getHasName(EBBlocks.WILLOW_PLANKS.get()), has(EBBlocks.WILLOW_PLANKS.get())).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.WILLOW_HANGING_SIGN.get(), 6)
                ...
                .pattern("@ @")
                .pattern("###")
                .pattern("###").unlockedBy(getHasName(EBBlocks.STRIPPED_WILLOW_LOG.get()), has(EBBlocks.STRIPPED_WILLOW_LOG.get())).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, EBBlocks.ROSE_BUNDLE.get(), 4)
                ...
                .pattern("#@#").unlockedBy(getHasName(EBBlocks.ROSE.get()), has(EBBlocks.ROSE.get())).save(recipeOutput);

        stairBuilder(EBBlocks.MAPLE_STAIRS.get(), Ingredient.of(EBBlocks.MAPLE_PLANKS.get()))
                .unlockedBy(getHasName(EBBlocks.MAPLE_PLANKS.get()), has(EBBlocks.MAPLE_PLANKS.get())).save(recipeOutput);
        ...
        stairBuilder(EBBlocks.MAPLE_MOSAIC_STAIRS.get(), Ingredient.of(EBBlocks.MAPLE_MOSAIC.get()))
                .unlockedBy(getHasName(EBBlocks.MAPLE_MOSAIC.get()), has(EBBlocks.MAPLE_MOSAIC.get())).save(recipeOutput);
        ...
        EBmosaicBuilder(EBBlocks.MAPLE_MOSAIC.get(), Ingredient.of(EBBlocks.MAPLE_SLAB.get()))
                .unlockedBy(getHasName(EBBlocks.MAPLE_SLAB.get()), has(EBBlocks.MAPLE_SLAB.get())).save(recipeOutput);
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, EBBlocks.MAPLE_PLANKS.get(), 4).requires(EBBlocks.MAPLE_LOG.get())
                .unlockedBy(getHasName(EBBlocks.MAPLE_LOG.get()), has(EBBlocks.MAPLE_LOG.get())).save(recipeOutput);
        ...
        woodBuilder(EBBlocks.STRIPPED_MAPLE_WOOD.get(), Ingredient.of(EBBlocks.STRIPPED_MAPLE_LOG.get()))
                .unlockedBy(getHasName(EBBlocks.STRIPPED_MAPLE_LOG.get()), has(EBBlocks.STRIPPED_MAPLE_LOG.get())).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.REDSTONE, EBBlocks.MAPLE_PRESSURE_PLATE.get())
                ...
                .pattern("##").unlockedBy(getHasName(EBBlocks.MAPLE_PLANKS.get()), has(EBBlocks.MAPLE_PLANKS.get())).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.MAPLE_HANGING_SIGN.get(), 6)
                ...
                .pattern("@ @")
                .pattern("###")
                .pattern("###").unlockedBy(getHasName(EBBlocks.STRIPPED_MAPLE_LOG.get()), has(EBBlocks.STRIPPED_MAPLE_LOG.get())).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, EBBlocks.RED_MAPLE_LEAVES_PILE.get(), 3)
                ...
                .pattern("##").unlockedBy(getHasName(EBBlocks.RED_MAPLE_LEAVES.get()), has(EBBlocks.RED_MAPLE_LEAVES.get())).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, EBBlocks.ORANGE_MAPLE_LEAVES_PILE.get(), 3)
                ...
                .pattern("##").unlockedBy(getHasName(EBBlocks.ORANGE_MAPLE_LEAVES.get()), has(EBBlocks.ORANGE_MAPLE_LEAVES.get())).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, EBBlocks.YELLOW_MAPLE_LEAVES_PILE.get(), 3)
                ...
                .pattern("##").unlockedBy(getHasName(EBBlocks.YELLOW_MAPLE_LEAVES.get()), has(EBBlocks.YELLOW_MAPLE_LEAVES.get())).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.HOLLOW_ANCIENT_LOG.get(), 8)
                ...
                .pattern("###")
                .pattern("# #")
                .pattern("###").unlockedBy(getHasName(EBBlocks.ANCIENT_LOG.get()), has(EBBlocks.ANCIENT_LOG.get())).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.HOLLOW_STRIPPED_OAK_LOG.get(), 8)
                ...
                .pattern("###")
                .pattern("# #")
                .pattern("###").unlockedBy(getHasName(Blocks.STRIPPED_OAK_LOG), has(Blocks.STRIPPED_OAK_LOG)).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.HOLLOW_STRIPPED_CHERRY_LOG.get(), 8)
                ...
                .pattern("###")
                .pattern("# #")
                .pattern("###").unlockedBy(getHasName(Blocks.STRIPPED_CHERRY_LOG), has(Blocks.STRIPPED_CHERRY_LOG)).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.HOLLOW_STRIPPED_MANGROVE_LOG.get(), 8)
                ...
                .pattern("###")
                .pattern("# #")
                .pattern("###").unlockedBy(getHasName(Blocks.STRIPPED_MANGROVE_LOG), has(Blocks.STRIPPED_MANGROVE_LOG)).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.HOLLOW_STRIPPED_DARK_OAK_LOG.get(), 8)
                ...
                .pattern("###")
                .pattern("# #")
                .pattern("###").unlockedBy(getHasName(Blocks.STRIPPED_DARK_OAK_LOG), has(Blocks.STRIPPED_DARK_OAK_LOG)).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.HOLLOW_STRIPPED_ACACIA_LOG.get(), 8)
                ...
                .pattern("###")
                .pattern("# #")
                .pattern("###").unlockedBy(getHasName(Blocks.STRIPPED_ACACIA_LOG), has(Blocks.STRIPPED_ACACIA_LOG)).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.HOLLOW_STRIPPED_JUNGLE_LOG.get(), 8)
                ...
                .pattern("###")
                .pattern("# #")
                .pattern("###").unlockedBy(getHasName(Blocks.STRIPPED_JUNGLE_LOG), has(Blocks.STRIPPED_JUNGLE_LOG)).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.HOLLOW_STRIPPED_BIRCH_LOG.get(), 8)
                ...
                .pattern("###")
                .pattern("# #")
                .pattern("###").unlockedBy(getHasName(Blocks.STRIPPED_BIRCH_LOG), has(Blocks.STRIPPED_BIRCH_LOG)).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.HOLLOW_STRIPPED_SPRUCE_LOG.get(), 8)
                ...
                .pattern("###")
                .pattern("# #")
                .pattern("###").unlockedBy(getHasName(Blocks.STRIPPED_SPRUCE_LOG), has(Blocks.STRIPPED_SPRUCE_LOG)).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.HOLLOW_STRIPPED_CRIMSON_STEM.get(), 8)
                ...
                .pattern("###")
                .pattern("# #")
                .pattern("###").unlockedBy(getHasName(Blocks.STRIPPED_CRIMSON_STEM), has(Blocks.STRIPPED_CRIMSON_STEM)).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.HOLLOW_STRIPPED_WARPED_STEM.get(), 8)
                ...
                .pattern("###")
                .pattern("# #")
                .pattern("###").unlockedBy(getHasName(Blocks.STRIPPED_WARPED_STEM), has(Blocks.STRIPPED_WARPED_STEM)).save(recipeOutput);
...
//the bite of 87?
        ...
        stairBuilder(EBBlocks.MOSSY_POLISHED_STONE_BRICK_STAIRS.get(), Ingredient.of(EBBlocks.MOSSY_POLISHED_STONE_BRICKS.get()))
                .unlockedBy(getHasName(EBBlocks.MOSSY_POLISHED_STONE_BRICKS.get()), has(EBBlocks.MOSSY_POLISHED_STONE_BRICKS.get())).save(recipeOutput);
...
//oh no covid 19
        ...
        doorBuilder(EBBlocks.IRON_BAR_DOOR.get(), Ingredient.of(Blocks.IRON_BARS))
                .unlockedBy(getHasName(Blocks.IRON_BARS), has(Blocks.IRON_BARS)).save(recipeOutput);
        ...
        fourforfourBuilder(EBBlocks.KNITTED_RED_WOOL.get(), Ingredient.of(Blocks.RED_WOOL))
                .unlockedBy(getHasName(Blocks.RED_WOOL), has(Blocks.RED_WOOL)).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, EBBlocks.KNITTED_RED_CARPET.get(), 3)
                ...
                .pattern("##").unlockedBy(getHasName(EBBlocks.KNITTED_RED_WOOL.get()), has(EBBlocks.KNITTED_RED_WOOL.get())).save(recipeOutput);

        stairBuilder(EBBlocks.KNITTED_RED_STAIRS.get(), Ingredient.of(EBBlocks.KNITTED_RED_WOOL.get()))
                .unlockedBy(getHasName(EBBlocks.KNITTED_RED_WOOL.get()), has(EBBlocks.KNITTED_RED_WOOL.get())).save(recipeOutput);
        ...
        fourforfourBuilder(EBBlocks.KNITTED_CYAN_WOOL.get(), Ingredient.of(Blocks.CYAN_WOOL))
                .unlockedBy(getHasName(Blocks.CYAN_WOOL), has(Blocks.CYAN_WOOL)).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, EBBlocks.KNITTED_CYAN_CARPET.get(), 3)
                ...
                .pattern("##").unlockedBy(getHasName(EBBlocks.KNITTED_CYAN_WOOL.get()), has(EBBlocks.KNITTED_CYAN_WOOL.get())).save(recipeOutput);

        stairBuilder(EBBlocks.KNITTED_CYAN_STAIRS.get(), Ingredient.of(EBBlocks.KNITTED_CYAN_WOOL.get()))
                .unlockedBy(getHasName(EBBlocks.KNITTED_CYAN_WOOL.get()), has(EBBlocks.KNITTED_CYAN_WOOL.get())).save(recipeOutput);
        ...
        fourforfourBuilder(EBBlocks.KNITTED_BLUE_WOOL.get(), Ingredient.of(Blocks.BLUE_WOOL))
                .unlockedBy(getHasName(Blocks.BLUE_WOOL), has(Blocks.BLUE_WOOL)).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, EBBlocks.KNITTED_BLUE_CARPET.get(), 3)
                ...
                .pattern("##").unlockedBy(getHasName(EBBlocks.KNITTED_BLUE_WOOL.get()), has(EBBlocks.KNITTED_BLUE_WOOL.get())).save(recipeOutput);

        stairBuilder(EBBlocks.KNITTED_BLUE_STAIRS.get(), Ingredient.of(EBBlocks.KNITTED_BLUE_WOOL.get()))
                .unlockedBy(getHasName(EBBlocks.KNITTED_BLUE_WOOL.get()), has(EBBlocks.KNITTED_BLUE_WOOL.get())).save(recipeOutput);
        ...
        fourforfourBuilder(EBBlocks.KNITTED_PURPLE_WOOL.get(), Ingredient.of(Blocks.PURPLE_WOOL))
                .unlockedBy(getHasName(Blocks.PURPLE_WOOL), has(Blocks.PURPLE_WOOL)).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, EBBlocks.KNITTED_PURPLE_CARPET.get(), 3)
                ...
                .pattern("##").unlockedBy(getHasName(EBBlocks.KNITTED_PURPLE_WOOL.get()), has(EBBlocks.KNITTED_PURPLE_WOOL.get())).save(recipeOutput);

        stairBuilder(EBBlocks.KNITTED_PURPLE_STAIRS.get(), Ingredient.of(EBBlocks.KNITTED_PURPLE_WOOL.get()))
                .unlockedBy(getHasName(EBBlocks.KNITTED_PURPLE_WOOL.get()), has(EBBlocks.KNITTED_PURPLE_WOOL.get())).save(recipeOutput);
        ...
        fourforfourBuilder(EBBlocks.KNITTED_BLACK_WOOL.get(), Ingredient.of(Blocks.BLACK_WOOL))
                .unlockedBy(getHasName(Blocks.BLACK_WOOL), has(Blocks.BLACK_WOOL)).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, EBBlocks.KNITTED_BLACK_CARPET.get(), 3)
                ...
                .pattern("##").unlockedBy(getHasName(EBBlocks.KNITTED_BLACK_WOOL.get()), has(EBBlocks.KNITTED_BLACK_WOOL.get())).save(recipeOutput);

        stairBuilder(EBBlocks.KNITTED_BLACK_STAIRS.get(), Ingredient.of(EBBlocks.KNITTED_BLACK_WOOL.get()))
                .unlockedBy(getHasName(EBBlocks.KNITTED_BLACK_WOOL.get()), has(EBBlocks.KNITTED_BLACK_WOOL.get())).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.MIRALEN_BRICKS.get(), 4)
                ...
                .pattern("##")
                .pattern("##").unlockedBy(getHasName(EBBlocks.MIRALEN_BLOCK.get()), has(EBBlocks.MIRALEN_BLOCK.get())).save(recipeOutput);
        ...
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(EBBlocks.MIRALEN_BRICKS.get()), RecipeCategory.BUILDING_BLOCKS, EBBlocks.CRACKED_MIRALEN_BRICKS.get(), 0.1F, 200)
                .unlockedBy(getHasName(EBBlocks.MIRALEN_BRICKS.get()), has(EBBlocks.MIRALEN_BRICKS.get())).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.MIRALEN_TILES.get(), 4)
                ...
                .pattern("##")
                .pattern("##").unlockedBy(getHasName(EBBlocks.MIRALEN_BRICKS.get()), has(EBBlocks.MIRALEN_BRICKS.get())).save(recipeOutput);
        ...
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(EBBlocks.MIRALEN_TILES.get()), RecipeCategory.BUILDING_BLOCKS, EBBlocks.CRACKED_MIRALEN_TILES.get(), 0.1F, 200)
                .unlockedBy(getHasName(EBBlocks.MIRALEN_TILES.get()), has(EBBlocks.MIRALEN_TILES.get())).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, EBBlocks.MIRALEN_LAMP.get(), 2)
                ...
                .pattern("@#@")
                .pattern("#@#")
                .pattern("@#@").unlockedBy(getHasName(EBItems.MIRALEN_SHARDS.get()), has(EBItems.MIRALEN_SHARDS.get())).save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, EBBlocks.MIRALEN_GLASS_PANE.get(), 16)
                ...
                .pattern("###")
                .pattern("###").unlockedBy(getHasName(EBBlocks.MIRALEN_GLASS.get()), has(EBBlocks.MIRALEN_GLASS.get())).save(recipeOutput);
        ...
        verticalstairBuilder(EBBlocks.POLISHED_SULFURIC_BRIMSTONE_VERTICAL_STAIRS.get(), Ingredient.of(EBBlocks.POLISHED_SULFURIC_BRIMSTONE.get()))
                .unlockedBy(getHasName(EBBlocks.POLISHED_SULFURIC_BRIMSTONE.get()), has(EBBlocks.POLISHED_SULFURIC_BRIMSTONE.get())).save(recipeOutput);

        verticalstairBuilder(EBBlocks.POLISHED_SULFURIC_BRIMSTONE_BRICK_VERTICAL_STAIRS.get(), Ingredient.of(EBBlocks.POLISHED_SULFURIC_BRIMSTONE_BRICKS.get()))
                .unlockedBy(getHasName(EBBlocks.POLISHED_SULFURIC_BRIMSTONE_BRICKS.get()), has(EBBlocks.POLISHED_SULFURIC_BRIMSTONE_BRICKS.get())).save(recipeOutput);

        verticalstairBuilder(EBBlocks.POLISHED_SULFURIC_BRIMSTONE_TILE_VERTICAL_STAIRS.get(), Ingredient.of(EBBlocks.POLISHED_SULFURIC_BRIMSTONE_TILES.get()))
                .unlockedBy(getHasName(EBBlocks.POLISHED_SULFURIC_BRIMSTONE_TILES.get()), has(EBBlocks.POLISHED_SULFURIC_BRIMSTONE_TILES.get())).save(recipeOutput);

        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, EBBlocks.POLISHED_SULFURIC_BRIMSTONE_PILLAR.get(), 1)
                .define('#', EBBlocks.POLISHED_SULFURIC_BRIMSTONE_SLAB.get())
                .pattern("#")
                .pattern("#").unlockedBy(getHasName(EBBlocks.POLISHED_SULFURIC_BRIMSTONE_SLAB.get()), has(EBBlocks.POLISHED_SULFURIC_BRIMSTONE_SLAB.get())).save(recipeOutput);

        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, EBBlocks.POLISHED_SULFURIC_BRIMSTONE_PEDESTAL.get(), 3)
                .define('#', EBBlocks.POLISHED_SULFURIC_BRIMSTONE_SLAB.get()).define('@', EBBlocks.POLISHED_SULFURIC_BRIMSTONE_PILLAR.get())
                .pattern("###")
                .pattern(" @ ")
                .pattern("###").unlockedBy(getHasName(EBBlocks.POLISHED_SULFURIC_BRIMSTONE_SLAB.get()), has(EBBlocks.POLISHED_SULFURIC_BRIMSTONE_SLAB.get())).save(recipeOutput);

        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, EBBlocks.SULFURIC_BRIMSTONE_LAMP.get(), 4)
                .define('#', EBBlocks.POLISHED_SULFURIC_BRIMSTONE.get()).define('@', EBItems.FIERY_SHARDS.get())
                .pattern("@#@")
                .pattern("#@#")
                .pattern("@#@").unlockedBy(getHasName(EBItems.FIERY_SHARDS.get()), has(EBItems.FIERY_SHARDS.get())).save(recipeOutput);

        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, EBBlocks.SULFURIC_BRIMSTONE_WINDOW.get(), 2)
                .define('#', Items.NETHER_BRICK).define('@', EBItems.FIERY_SHARDS.get()).define('%', EBBlocks.POLISHED_SULFURIC_BRIMSTONE.get())
                .pattern("#@#")
                .pattern("@%@")
                .pattern("#@#").unlockedBy(getHasName(EBItems.FIERY_SHARDS.get()), has(EBItems.FIERY_SHARDS.get())).save(recipeOutput);
